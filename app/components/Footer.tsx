        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-white flex items-center gap-2">
              <span className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white text-sm">RU</span>
              Study Hub
            </h2>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-xs text-slate-500 mt-4">Version 1.0.0 (Beta)</li>
            </ul>
          </div>
        </div>
