...
export const metadata: Metadata = {
  title: "Previous Year Questions (PYQ) | Ranchi University BCA",
  description: "Download 2022, 2023, 2024 Semester Question Papers for Ranchi University BCA. Access the complete exam archive.",
};
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-blue-700 text-white py-12 px-4 text-center shadow-md">
        ...
        <p className="text-blue-100 max-w-2xl mx-auto">
          Access the archive of past question papers to understand exam patterns and important topics.
        </p>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-10 w-full flex-grow">
              ...
              <div className="p-4">
                <ul className="space-y-2">
                  {sem.subjects.map((sub) => (
                    <li key={sub.id}>
                      <Link 
                        href={`/semester/${sem.id}/${sub.id}?view=pyq`}
        ...
        <div className="mt-12 text-center text-sm text-gray-500">
          <p>
            Note: Papers are collected from students and library resources.
          </p>
        </div>
      </main>
    </div>
