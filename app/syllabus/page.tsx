...
export const metadata: Metadata = {
  title: "Official Syllabus | BCA Honours | Ranchi University",
  description: "View the complete CBCS Syllabus for BCA (Sem 1-6) at Ranchi University. Detailed unit-wise breakdown.",
};
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-blue-700 text-white py-12 px-4 text-center shadow-md">
        <h1 className="text-3xl font-bold mb-2">Syllabus Directory</h1>
        <p className="text-blue-100 max-w-2xl mx-auto">
          View the official Ranchi University BCA Honours curriculum for all semesters.
        </p>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-10 w-full flex-grow">
              ...
              <div className="p-4">
                <ul className="space-y-2">
                  {sem.subjects.map((sub) => (
                    <li key={sub.id}>
                      <Link 
                        href={`/semester/${sem.id}/${sub.id}?view=syllabus`}
        ...
        <div className="mt-12 text-center text-sm text-gray-500">
          <p>
            Note: The syllabus content is updated as per the CBCS Curriculum 2019-2022.
          </p>
        </div>
      </main>
    </div>
